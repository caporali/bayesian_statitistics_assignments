...
With the usual notation $b \deq an_0 + 1$ and $c = \sqrt{-n_0t_0}$: 
\begin{align*}
...
This leads us to conclude that 
   $$Y_{n + 1} | Y_{1:n} \sim f\left(B(a, an + b)\right), \text{ with } f: \real^+ \to \real^+, f(x) = \sqrt{\frac{x}{1 - x}} \sqrt{c^2 + \ssn{y}{n}}.$$