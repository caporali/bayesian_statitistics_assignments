...
post.data %>% ggplot()+
  ...
  geom_rect(aes(xmin = quant.interval.a[1], xmax = quant.interval.a[2], ymin = -Inf, ymax = Inf),
...
post.data %>% ggplot()+
  ...
  geom_rect(aes(xmin = quant.interval.b[1], xmax = quant.interval.b[2], ymin = -Inf, ymax = Inf), 
    fill = "orange", alpha = 0.002)+
  xlab(expression(theta)) +
  ylab(expression(paste("p(",theta[B],"|",y[B],")")))+
