...
t.a %>% ggplot()+
  ...
  scale_color_manual(name = "Legend", values = c( "sample mean" = "blue", "data mean" = "red"), labels = c("sample statistic", "data statistic"))
...
t.b %>% ggplot()+
  ...
  xlab("t")+
  ggtitle("Test Statistic empirical distribution")+
  scale_color_manual(name = "Legend", values = c( "sample statistic" = "blue", "data statistic" = "red"), labels = c("sample statistic", "data statistic"))
```
\normalsize
