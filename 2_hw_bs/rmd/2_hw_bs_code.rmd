...
- $Z_{i}$, for $i = 1, 2, 6, 8, 14, 15$ (here denoted as $Vi$). `r newline()`
  	These chains are rapresentative of the entire array of r.v.'s $Z_{1:25}$, indeed each of the $i$'s chosen represents an index with a different type of inizialization parameters in the \texttt{divorce} data frame: $x_i >/=/< 0$ and $y_i = 0/1$:
	\smallskip
	\scriptsize
	```{r, fig.align = "center", out.width = "75%"}
